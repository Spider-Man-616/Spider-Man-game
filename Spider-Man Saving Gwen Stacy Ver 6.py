...
def area_01():
    ...
    print()
    typewriter("Green Goblin: “Can the Spider come out to play?! I’ve got something he holds very dear in my hands.” He drawls mockingly before he cackles maniacally.")
    print()
